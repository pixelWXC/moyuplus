...
export async function buildEpubFixture(entries: Record<string, string | Buffer>, directories: string[] = []): Promise<string> {
  ...
  for (const directoryName of directories) zip.addEmptyDirectory(directoryName);
